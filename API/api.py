...
APIKEY1 = "AIzaSyAzyKWVhZcy34DTNF_pan3lh73rX8YA8iY"
APIKEY2 = 'AIzaSyAnqg0wXE85yPRcqOHc7dPO6zzkxJQLV4Q'
gs.configure(api_key=APIKEY1)
...
if __name__ == "__main__":
    app.run(debug = True, host = HOST, port = 5555)